...
class TestAddpethappypath():
  ...
  def test_addpethappypath(self):
    # Test name: add_pet_happy_path
    ...
    # Pet Added
    elements = self.driver.find_elements(By.CSS_SELECTOR, "tr:nth-child(2) dd:nth-child(2)")
