...
class TestUpdatepetname():
  ...
  def test_updatepetname(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "tr:nth-child(2) > td:nth-child(1) > a").click()
    self.driver.find_element(By.ID, "name").click()
    self.driver.find_element(By.ID, "name").send_keys(" Ben-1")
    self.driver.find_element(By.CSS_SELECTOR, ".btn").click()
    elements = self.driver.find_elements(By.CSS_SELECTOR, "h2:nth-child(8)")
